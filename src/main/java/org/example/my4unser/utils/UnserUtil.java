...
public class UnserUtil {
    ...
    public static void bytesToObject(byte[] bytes) throws Exception {
...
//        out.writeInt(2021);
    ...
    public static void b64StringToObject(String b64) throws Exception {
        Class base64;
        byte[] value = null;
        try {
            base64 = Class.forName("java.util.Base64");
            Object Decoder = base64.getMethod("getDecoder").invoke(base64, null);
            value = (byte[]) Decoder.getClass().getMethod("decode", new Class[]{byte[].class}).invoke(Decoder, new Object[]{b64});
            bytesToObject(value);
        } catch (Exception e) {
        }
    }
    ...
    public static void fieldSetValue(Object obj,String fieldName,Object value) throws Exception {
